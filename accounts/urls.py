...
urlpatterns = patterns('',
    ...
    url(regex=r'^password/reset/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$',view=password_reset_confirm, name='password_reset_confirm'),
    url(regex=r'^password_reset_complete/$',view=password_reset_complete,name='password_reset_complete'),
)
