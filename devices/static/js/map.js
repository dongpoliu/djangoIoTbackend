...
$(document).ready(function() {
  ...
  // create a map in the "map" div, set the view to a given place and zoom
    ...
    var southwest = L.latLng( 30.04, 111.39 );
    //var noreste = L.latLng(-60, -36);
    var northeast = L.latLng( 38.63807288847, 143.55 );
    var limites_mapa = L.latLngBounds(southwest, northeast );
